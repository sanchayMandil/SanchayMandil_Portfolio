...
function Header(){
    return(
        <>
        <nav className="flex top-0 fixed z-10 justify-start  text-white w-full max-md:flex-col">
            <h1 className="text-[1.5vw] font-bold bg-[#3f72d8] rounded-br-3xl px-[0.5vw] pt-[1.3vw] max-md:text-[5.5vw] max-md:text-center max-md:py-[2vw] max-md:rounded-br-[0rem]">{"<Sanchay Mandil>"}</h1>
            <div className=" flex text-2xl invert py-5 px-5">
                <ul className="flex space-x-10 max-md:flex-col max-md:space-y-[8vw]">
