  ...
  return (
    <section className="px-4 sm:px-[5vw] min-h-[80vh]">
      <div className="mx-auto flex flex-col md:flex-row items-center justify-between gap-8 md:gap-0">
        <div className="text-center md:text-left w-full md:w-[70%] space-y-7">
        ...
        <div className="w-full md:w-[30%] flex justify-center mt-8 md:mt-0">
          ...
          >
            {/* Profile Image */}
            <img
              className="relative h-70 sm:h-64 md:h-75 w-70 sm:w-64 md:w-100 object-cover rounded-full border-8 border-transparent shadow-2xl transition-transform duration-300 group-hover:scale-105"
